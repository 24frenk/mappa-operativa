...
// 👉 Funzione per formattare la data ISO in stile italiano
...
async function fetchStateFromGitHub() {
    try {
        ...
        updateSyncUI("OK", formatLastSync(last));
...
div.classList.remove("yellow", "red", "orange");

/* Applica la classe corretta + testo */
if (standby) {
    ...
    div.appendChild(l);
} else if (type === "ambulanza" || type === "squadra") {
    const l = document.createElement("div");
    l.className = "sidebar-unit-line";
    l.innerHTML = "<b>Stato:</b> Operativo";
    div.appendChild(l);
}
